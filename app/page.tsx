  ...
  return (
    <>
      ...
      <div className="flex flex-col bg-[#f3f4f6] dark:bg-secondary">
        ...
        <div
          id="contributions"
          className="bg-white px-3 py-[2%] lg:px-[8%] dark:bg-[#313131] dark:text-white"
        >
          <p className="py-5 font-bold text-primary">NPM Contributions</p>
          <div className="flex items-center justify-between">
            <p className="w-48 text-xl font-bold text-primary lg:w-96 lg:text-3xl">
              My Open Source Packages
            </p>
            <Link
              href="/contributions"
              className="whitespace-nowrap border-2 border-primary p-2 transition-all duration-300 hover:bg-primary hover:text-white"
            >
              View All Packages
            </Link>
          </div>
          <div className="grid grid-cols-1 gap-6 py-10 md:grid-cols-2 lg:grid-cols-3">
            <div className="flex flex-col gap-4 border-b-8 border-primary bg-[#f3f4f6] p-5 shadow-lg dark:bg-[#0B0A10]">
              <div className="flex items-center justify-between">
              ...
              <p className="text-opacity-60 dark:text-white">
                ...
                window resizing, and debouncing functions. Easy to install with comprehensive
            ...
            <div className="flex flex-col gap-4 border-b-8 border-primary bg-[#f3f4f6] p-5 shadow-lg dark:bg-[#0B0A10]">
              ...
              <p className="text-opacity-60 dark:text-white">
                ...
                offers a simple API to persist and synchronize state with browser storage
                mechanisms, supporting various data types including strings, numbers, objects, and
                arrays with automatic serialization and type safety.
              </p>
        ...
        <div className="flex flex-col justify-between gap-2 border-l-4 border-primary bg-zinc-50 px-3 py-[4%] lg:flex-row lg:items-center lg:border-l-8 lg:px-[8%] dark:bg-[#0B0A10] dark:text-white">
