  ...
  return (
    <div className="flex flex-col dark:bg-secondary">
      <div className="flex flex-col dark:text-white w-full min-h-screen px-3 lg:px-[8%]">
        ...
        >
          <div className="flex flex-col-reverse lg:flex-row overflow-hidden lg:pr-20" >
            ...
            <div className="svg-frame">
              <svg style={{ '--i': 0, '--j': 0 } as React.CSSProperties}>
                <g id="out1">
                  ...
                  <path mask="url(#path-1-inside-1_111_3212)" strokeMiterlimit="16" strokeWidth="2" stroke="#069110" d="M72 172C72 116.772 116.772 72 172 72C227.228 72 272 116.772 272 172C272 227.228 227.228 272 172 272C116.772 272 72 227.228 72 172ZM197.322 172C197.322 158.015 185.985 146.678 172 146.678C158.015 146.678 146.678 158.015 146.678 172C146.678 185.985 158.015 197.322 172 197.322C185.985 197.322 197.322 185.985 197.322 172Z"></path>
                </g>
              </svg>
